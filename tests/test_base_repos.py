...
class TestRepository:
    ...
    def test_BatchOperations_IndependentEntityRepository(self, docker_dynamodb):
        ...
        items_to_create = []
        for i in range(100):
            item = (f'TE{i:03}',  {'id': f'TE{i:03}', 'name': f'p{i:03}'})
        ...
        for i in range(len(item_list)):
            ...
            assert item['id'] == f'TE{i:03}'
            assert item['name'] == f'p{i:03}'
    ...
    def test_BatchOperations_AssociativeEntityRepository(self, docker_dynamodb):
        ...
        for i in range(len(item_list)):
            ...
            assert item['SK'] == f'PARENT_ENTITY#P1E{i:03}'
            assert item['GSI1'] == f'ENTITY#E{i:03}'
            assert item['name'] == f'P1E{i:03}'
